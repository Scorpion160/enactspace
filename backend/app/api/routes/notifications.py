...
VALID_NOTIFICATION_TYPES = {
    ...
    "attendance_justification_pending",
    "attendance_justification_approved",
    "attendance_justification_rejected",
    "absence_recorded",
    "finance_fee",
    "finance_penalty",
    "fee_due",
    ...
    "impact_validated",
    "impact_rejected",
    "impact_metric_submitted",
    "impact_metric_validated",
    "impact_metric_rejected",
    "impact_evidence_submitted",
    "impact_evidence_validated",
    "impact_evidence_rejected",
    "academy_completed",
    "quiz_passed",
    "badge_awarded",
    "archive_validated",
